module Task
  ...
  def self.local_modular_manifests_path
    File.expand_path File.join module_path, 'osnailyfacter', 'modular'
  end

  def self.node_modular_manifests_path
    '/etc/puppet/modules/osnailyfacter/modular'
  end

  def self.task_extension_file_name
  ...
  def self.hiera_data_task_override
